...
class groomigseeall7 extends StatefulWidget {
  const groomigseeall7({super.key});

  @override
  State<groomigseeall7> createState() => _groomigseeall7State();
}

class _groomigseeall7State extends State<groomigseeall7> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Petvit Tick Repellent Powder with Sandalwood & Bakuchi 100gm',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('₹225',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
                        fontSize: 14,
              ...
              Row(
                children: [
                  Column(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 20,bottom: 110),
                        child: Text('Brand\nItem Form\nAge Range (Description)\nItem Volume\nTarget Species\nAllergen Information',style: TextStyle(
                            color: Colors.black,
                  ...
                  Padding(
                      padding: EdgeInsets.only(left: 20,bottom: 110),
                      child: Column(
                        children: [
                          Text('Petvit\nPowder\nAll Life Stages\n100 Millilitres\nDog\nEgg Free',
                            style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Powerful Tick and Flea Defense: Safeguard your pets from ticks and fleas with Petvit Tick Repellent Powder.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Relieves Itching: Helps with the soothing relief from constant itching with this specially formulated powder.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Fungal Infections: Address fungal infections for healthier skin with the natural ingredients in this powder.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Paraben-Free and pH-Balanced: Rest easy knowing that this powder is free from harmful parabens and maintains the ideal pH balance.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Healthy, Shiny Coat: Enhance your pets appearance with a healthy and shiny coat through the use of Petvit Tick Repellent Powder.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Alleviates Scratching: Help your pets find relief from discomfort and scratching with this effective powder.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Natural Ingredients: Enriched with beneficial ingredients like Bakuchi and Mahanimb for superior efficacy.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
