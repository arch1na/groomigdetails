...
class groomigseeall10 extends StatefulWidget {
  const groomigseeall10({super.key});

  @override
  State<groomigseeall10> createState() => _groomigseeall10State();
}

class _groomigseeall10State extends State<groomigseeall10> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Good Mama Quick Relief Tick & Flea Ayurvedic Oil for Dogs & Cats-Kills Infestation, Soothes Itchy Flaky Skin, Moisturises Dull Coat, Coconut Oils 100ml',style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Ingredients: Cold-pressed Coconut oil, Neem oil, Karanj oil and Castor oil.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Intended Use: Repels/Kills Ticks / Fleas / Parasites / Fungal Infections, Kills any eggs on skin, Relieves Itching, Reduces Shedding',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Breed Recommendation: All Breeds',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Specific Uses: Anti Tick / Flea, Relieves Itching, Reduces Flakey Skin, Moisturises and Soothes Inflamed Skin, Reduces Shedding.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Special Features: 100% Natural Ayurvedic Blend. Safe for Everyday Use.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
