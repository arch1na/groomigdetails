...
class groomigseeall4 extends StatefulWidget {
  const groomigseeall4({super.key});

  @override
  State<groomigseeall4> createState() => _groomigseeall4State();
}

class _groomigseeall4State extends State<groomigseeall4> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Fifozone Bigboss Shampoo 200 ml for Dogs',style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Text('  ₹220',style: TextStyle(decoration: TextDecoration.lineThrough,
                      color: Color(0xff636161),
                      fontFamily: 'Inter',
              ...
              Padding(
                ...
                child: Text('- Fifozone Shampoo for Dogs',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              // Padding(
              //   padding: const EdgeInsets.only(left: 30),
              //   child: Text('- An effective anti-bacterial & flea shampoo with bactericidal & fungicidal properties. With goodness of various herbal protein & cucumber, cleanses & conditions the hair.',style: TextStyle(
              //       color: Colors.black,
              //       fontFamily: 'AbhayaLibre',
              //       fontSize: 16
              //   ),),
