...
class groomigseeall9 extends StatefulWidget {
  const groomigseeall9({super.key});

  @override
  State<groomigseeall9> createState() => _groomigseeall9State();
}

class _groomigseeall9State extends State<groomigseeall9> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Heads Up For Tails Natural Anti Tick and Flea Powder for Dog & Cat - 100g',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('₹199',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
                        fontSize: 14,
              ...
              Padding(
                ...
                child: Text('- Dog Natural anti-tick and flea powder',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Suitable for dogs and cats',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Made with Diatomaceous Earth (Food Grade)',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Non-toxic and chemical free',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Not suitable for pregnant pets',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
