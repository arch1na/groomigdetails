...
class groomigseeall8 extends StatefulWidget {
  const groomigseeall8({super.key});

  @override
  State<groomigseeall8> createState() => _groomigseeall8State();
}

class _groomigseeall8State extends State<groomigseeall8> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('PetalC Perfumed Talc Powder for Pets (100g_ArePetalc100)',style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- PetalC is an Excellent Ultra Fine Perfumed Talc which allows easy penetration of the Talc to the coat.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Helps prevent Fungal Growth on skin of pet.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- PetalC is recommended for use between 2 baths to allow pets smell fresh throughout the time.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Regular use of PetalC minimizes chances of infection in the highly exposed & moist part of the body.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Sprinkle PetalC on the body parts of pet and followed by brushing to allow the talc to reach to the skin.',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
