...
class groomigseeall5 extends StatefulWidget {
  const groomigseeall5({super.key});

  @override
  State<groomigseeall5> createState() => _groomigseeall5State();
}

class _groomigseeall5State extends State<groomigseeall5> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Dog Lovers Notix Goodness Freshness Neem Pet Soap (Green.75 g) - Pack of 3',style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Text('  ₹240',style: TextStyle(decoration: TextDecoration.lineThrough,
                      color: Color(0xff636161),
                      fontFamily: 'Inter',
                  ...
                  Column(
                    children: [
                      Padding(
                        ...
                        child: Text('Item Form\nSkin Type\nBrand\nScent\nAge Range (Description)\nNet Quantity	\nSpecial Feature',style: TextStyle(
                            color: Colors.black,
              ...
              Padding(
                ...
                child: Text('- Suited for: dogs',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 30),
                child: Text('- Ingredients: alpha tocopherol, melia azadirchta, neem oil and lime',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Package content: 3 notix soap',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
