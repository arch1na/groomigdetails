...
class groomigseeall1 extends StatefulWidget {
  const groomigseeall1({super.key});

  @override
  State<groomigseeall1> createState() => _groomigseeall1State();
}

class _groomigseeall1State extends State<groomigseeall1> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Jumbo Green Jumbo Glo ( 2 in 1 ) for Pets ( Cats and Dogs )',style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Text('  ₹315',style: TextStyle(decoration: TextDecoration.lineThrough,
                      color: Color(0xff636161),
                      fontFamily: 'Inter',
              ...
              Padding(
                ...
                child: Text('- Whitening Shampoo',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(right: 150),
                child: Text('- Moisturising Shampoo',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Lasting Fragrance',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Wavy Hair',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Tangles or Knots',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
