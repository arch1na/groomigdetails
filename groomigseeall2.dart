...
class groomigseeall2 extends StatefulWidget {
  const groomigseeall2({super.key});

  @override
  State<groomigseeall2> createState() => _groomigseeall2State();
}

class _groomigseeall2State extends State<groomigseeall2> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Petlicious & More 1000 ml Bio Clean Neem Shampoo for Dog & Cats',style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Text('  ₹699',style: TextStyle(decoration: TextDecoration.lineThrough,
                      color: Color(0xff636161),
                      fontFamily: 'Inter',
