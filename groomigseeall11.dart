...
class groomigseeall11 extends StatefulWidget {
  const groomigseeall11({super.key});

  @override
  State<groomigseeall11> createState() => _groomigseeall11State();
}

class _groomigseeall11State extends State<groomigseeall11> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Papa Pawsome Shine O Fur Massage Oil for Dogs with Natural Ingredients 100ml',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('₹269',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
                        fontSize: 14,
